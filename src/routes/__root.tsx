...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SIMShield 360 — Multi-Layer SIM Swap Prevention" },
      { name: "description", content: "Enterprise telecom security platform that prevents SIM swap, eSIM transfer and port-out fraud through a 7-layer authorization firewall." },
